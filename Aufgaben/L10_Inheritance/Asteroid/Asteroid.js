...
(function (L10_Inheritance_Asteroids) {
    class Asteroid extends L10_Inheritance_Asteroids.Moveable {
        ...
        draw() {
            ...
            L10_Inheritance_Asteroids.crc2.scale(this.size, this.size);
            L10_Inheritance_Asteroids.crc2.translate(-50, -50);
            L10_Inheritance_Asteroids.crc2.lineWidth = L10_Inheritance_Asteroids.linewidth / this.size;
            L10_Inheritance_Asteroids.crc2.stroke(L10_Inheritance_Asteroids.asteroidPaths[this.type]);
            L10_Inheritance_Asteroids.crc2.restore();
        }
        isHit(_hotspot) {
            let hitssize = 50 * this.size;
            let difference = new L10_Inheritance_Asteroids.Vector(_hotspot.x - this.position.x, _hotspot.y - this.position.y);
    ...
    L10_Inheritance_Asteroids.Asteroid = Asteroid;
