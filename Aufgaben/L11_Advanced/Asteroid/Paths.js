...
(function (L11_Advanced_Asteroids) {
    L11_Advanced_Asteroids.shapeAsteroids = [
        [
    ...
    function createPaths() {
        L11_Advanced_Asteroids.asteroidPaths = createAsteroidPaths(L11_Advanced_Asteroids.shapeAsteroids);
        L11_Advanced_Asteroids.ufoPath = createUfoPath();
    }
    L11_Advanced_Asteroids.createPaths = createPaths;
